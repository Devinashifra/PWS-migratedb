...
public class ListJpaController implements Serializable {
    ...
    public List<klmpk8.tratix.List> findListEntities() {
        return findListEntities(true, -1, -1);
    }

    public List<klmpk8.tratix.List> findListEntities(int maxResults, int firstResult) {
        return findListEntities(false, maxResults, firstResult);
    }

    private List<klmpk8.tratix.List> findListEntities(boolean all, int maxResults, int firstResult) {
    ...
    public klmpk8.tratix.List findList(String id) {
        EntityManager em = getEntityManager();
        try {
